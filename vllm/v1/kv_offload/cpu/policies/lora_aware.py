...
"""LoRA-aware KV cache eviction policies that coordinate adapter residency
with block eviction. Most policies wrap a base ``CachePolicy`` via the
decorator pattern."""
...
# Loose-style variants apply each tight-policy idea (hysteresis, decayed
# frequency, ghost lists) to the protection set rather than to selection.
