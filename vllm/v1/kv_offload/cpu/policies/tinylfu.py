...
"""W-TinyLFU (Einziger et al., EuroSys 2014): LRU window + SLRU main +
...
class TinyLFUCachePolicy(CachePolicy):
    ...
    def insert(self, bh: BlockHash, block: BlockStatus) -> None:
        ...
        # Window may temporarily exceed its nominal size; evict() trims.
        # Window→probation promotion happens on touch().
    ...
    def evict(
        ...
        # Evict probation → window → protected (coldest segment first).
